...
for distance in distance_values:
	...
	maxprob_dl.append((distance, one_tracks_ng0.max_end_prob, one_tracks_ng.max_end_prob))
	time_dl.append((distance, det_time))

np.savetxt('maxprob_dl.txt', maxprob_dl)
np.savetxt('time_dl.txt', time_dl)
